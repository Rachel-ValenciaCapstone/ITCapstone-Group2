    ...
    <section class="order-confirmation" style="margin-top: 75px;">
        ...
        <div class="info-block">
            <div class="shipping-info">
                ...
                <h4>Customer Name</h4>
                <p id="address" style="margin-bottom: 0;">1234 Anywhere Dr. <br> City, State Unitied States 98765</p> 
                <p id="phone" style="margin-top: 0;">###-###-####</p> 
            </div>
            ...
            <div class="cart order-summary" style="width: 45%; margin-right: 20px;">
                <div class="cart-item-box">
                    ...
                    <div class="product-card">
                        <div class="card">
                            <div class="img-box">
                                <img src="img/products/acrylic 1a.jpg" alt="Acrylic Gouache Set" width="160px" class="summary-img">
                            </div>

                            <div class="detail orderconf-detail">
                                <h4 class="orderconf-name">Acrylic Gouache Set <span class="orderconf-price"> $ <span id="price">75.00</span></span></h4>
                            </div>
                        </div>
                    </div>
            ...
            <div class="cart order-summary" style="height:285px; width: 30%; margin-left: 30px;">
                <div class="cart-item-box">
                    ...
                    <div class="amount" style="padding: 0;">
                        <div class="subtotal">
                            <span>Subtotal</span> <span>$ <span id="subtotal">75.00</span></span>
                        </div>
                        <div class="shipping">
                            <span>Shipping fee</span> <span>$ <span id="shipping">6.99</span></span>
                        </div>
                        <div class="discount">
                            <span>Discount</span> <span>$ <span name="discount-token" id="discount-token">0.00</span></span>
                        </div>
                        <div class="tax">
                            <span>Sales tax</span> <span>$ <span id="tax">4.88</span></span>
                        </div>
                        <div class="total">
                            <span>Grand total</span> <span>$ <span id="total">86.87</span></span>
                        </div>
                    </div>
                </div>
            </div>
