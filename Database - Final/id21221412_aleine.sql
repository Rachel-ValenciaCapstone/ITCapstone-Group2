...
--
-- Host: localhost:3306
-- Generation Time: Dec 01, 2023 at 10:09 PM
...
ALTER TABLE `orders`
  ...
  ADD KEY `fk_orders_users1_idx` (`user_user_id`);
...
ALTER TABLE `payment methods`
  ADD PRIMARY KEY (`payment_method_id`,`user_user_id`),
  ADD KEY `fk_payment methods_users1_idx` (`user_user_id`);
...
--
ALTER TABLE `addresses`
  ADD CONSTRAINT `fk_addresses_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_orders_user` FOREIGN KEY (`user_user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_orders_users1` FOREIGN KEY (`user_user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `order_items`
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `fk_order_items_orders` FOREIGN KEY (`orders_order_id`,`orders_users_user_id`) REFERENCES `orders` (`order_id`, `user_user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_order_items_orders1` FOREIGN KEY (`orders_order_id`,`orders_users_user_id`) REFERENCES `orders` (`order_id`, `user_user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `payment methods`
--
ALTER TABLE `payment methods`
  ADD CONSTRAINT `fk_payment methods_users1` FOREIGN KEY (`user_user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `fk_reviews_user` FOREIGN KEY (`users_user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE,
